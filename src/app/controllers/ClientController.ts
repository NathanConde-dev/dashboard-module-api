...
// Endpoint para upload de dados de clientes a partir de uma planilha
    ...
    async (req: Request, res: Response): Promise<Response> => {
      ...
      try {
        ...
        for (const row of rows) {
          ...
          console.log(`Processing row: Nome=${Nome}, Email=${Email}, Identificador=${Identificador}, Telefone=${Telefone}`);
